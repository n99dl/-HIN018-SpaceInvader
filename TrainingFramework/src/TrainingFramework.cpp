...
void Mouse(ESContext* esContext, GLint x, GLint y, int bbIsPresseded)
{
...
GLint _tmain(GLint argc, _TCHAR* argv[])
{
	...
	esCreateWindow(&esContext, "Space Intruder", screenWidth, screenHeight, ES_WINDOW_RGB | ES_WINDOW_DEPTH);
	if (Init(&esContext) != 0)
		return 0;
