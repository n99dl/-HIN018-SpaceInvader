...
LRESULT WINAPI ESWindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONUP:
	{
		...
		if (esContext && esContext->mouseFunc)
			esContext->mouseFunc(esContext, (int)point.x - WDpoint.x , (int)point.y - WDpoint.y , 0);
	}
	break;
	case WM_LBUTTONDOWN:
	{
	...
	case WM_MOUSEMOVE:
	{
		...
		GetCursorPos(&point);
		if (esContext && esContext->mouseFunc)
			esContext->mouseFunc(esContext, (int)point.x - WDpoint.x, (int)point.y - WDpoint.y, 2);
	}
	default:
